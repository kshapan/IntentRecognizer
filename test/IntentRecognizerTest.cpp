...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(std::make_tuple("What is the weather like today?",
                                      "Get Weather"),
                      std::make_tuple("Will it rain tomorrow in paris?",
                                      "Get Weather"),
                      std::make_tuple("What is the weather like in Paris today?",
                                      "Get Weather City"),
                      std::make_tuple("What is the weather like in New York today?",
                                      "Get Weather City"),
                      std::make_tuple("How is the weather in Paris today?",
                                      "Get Weather City"),
                      std::make_tuple("How is the weather in New York today?",
                                      "Get Weather City"),
                      std::make_tuple("Am I free at 13:00 PM tomorrow?",
                                      "Check Calender"),
                      std::make_tuple("Do I have appointment at 13:00 PM tomorrow?",
                                      "Check Calender"),
                      std::make_tuple("Check if I have meeting at 13:00 PM with manager today?",
                                      "Check Calender"),
                      std::make_tuple("Tell me an interesting fact.",
                                      "Get Fact"),
                      std::make_tuple("Get fact on mars landing.",
                                      "Get Fact"),
